        ...
        <router-link to="/personal">
          <div class="perIcon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-labelledby="shopicon" role="presentation" width="30" height="30">
              <g transform="matrix(1.3333333,0,0,-1.3333333,0,92)">
                <g transform="scale(0.0075)">
                  <path d="M 7545.23,0.0117188 H 7040.2 C 6942.93,1296.49 6112.97,2383.05 4970.74,2839.34 4607.62,2662.08 4202.38,2559.89 3772.62,2559.89 c -429.81,0 -835,102.03 -1198.13,279.45 C 1432.23,2382.9 602.301,1296.49 505,0.0117188 H 0 C 89.8398,1384.66 903.629,2566.22 2059.49,3164.15 1414.84,3679.97 999.488,4477.94 999.488,5375.95 999.488,6931.41 2241.13,8192 3772.62,8192 c 1531.6,0 2773.08,-1260.59 2773.08,-2816.05 0,-898.01 -415.19,-1695.98 -1060,-2211.8 C 6641.72,2566.06 7455.12,1384.5 7545.23,0.0117188 Z M 6041.52,5375.95 c 0,1272.38 -1015.9,2304.02 -2268.9,2304.02 -1253.17,0 -2268.95,-1031.64 -2268.95,-2304.02 0,-1272.39 1015.94,-2303.87 2268.95,-2303.87 1253,0 2268.9,1031.48 2268.9,2303.87 z" ></path>
                </g>
              </g>
            </svg>
          </div>
        </router-link>
        <router-link v-if="isBuyer" to="/cart">
          <div class="cartitem">
            <div v-if="cartTotal > 0" class="cartcount">{{ cartTotal }}</div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-labelledby="shopicon" role="presentation" width="30" height="30">
              <title id="cart">Shopping Cart</title>
              <path fill="black" d="M8.01 10c-1.104 0-2 .896-2 2 0 1.105.896 2 2 2h10.376l10.53 49.813c-.107 1.14.952 2.245 2.095 2.187h50c1.057.015 2.03-.943 2.03-2s-.973-2.015-2.03-2H32.637l-1.688-8H85.01c.896-.01 1.742-.69 1.938-1.562l7-30c.26-1.16-.748-2.43-1.937-2.438H23.76l-1.78-8.437c-.2-.884-1.063-1.57-1.97-1.563zm16.594 14H89.51l-6.093 26H30.104zM42.01 72c-4.946 0-9 4.053-9 9s4.054 9 9 9c4.948 0 9-4.053 9-9s-4.052-9-9-9zm28 0c-4.946 0-9 4.053-9 9s4.054 9 9 9c4.948 0 9-4.053 9-9s-4.052-9-9-9zm-28 4c2.786 0 5 2.215 5 5s-2.214 5-5 5c-2.784 0-5-2.215-5-5s2.216-5 5-5zm28 0c2.786 0 5 2.215 5 5s-2.214 5-5 5c-2.784 0-5-2.215-5-5s2.216-5 5-5z"></path>
            </svg>
          </div>
        </router-link>
      </div>
