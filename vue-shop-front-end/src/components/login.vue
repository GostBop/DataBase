<template>
  <div id="container">
    <svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-labelledby="shopicon" role="presentation" width="150" height="150">
      <title id="shopicon">
        Magi Shop
      </title>
      <g fill="black">
    ...
    <div id="detail">
      <div id="type">
        <label>Seller<input name="category" type="radio" v-model="category" value="seller"></label>
        <label>Buyer<input name="category" type="radio" v-model="category" value="buyer"></label>
      </div>
      <component :is="view" :category="category" @change-to-register="view='register'" @change-to-login="view='login'">
      </component>
    </div>
  </div>
</template>
